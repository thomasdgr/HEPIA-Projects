...
def create_instance(node_nb):
    return ec2.create_instances(
            ...
            SecurityGroupIds=['sg-0b5f61c38fd5ce3e4',],
            KeyName='thomas-aids',
            UserData="""
            #cloud-config
...
try:
    ...
    for ip in ips:
       os.system( "scp -o StrictHostKeyChecking=no -i ~/.ssh/thomas-aids.pem -r ../server_infos/ ec2-user@" + ip + ":/home/ec2-user")
       os.system( "scp -o StrictHostKeyChecking=no -i ~/.ssh/thomas-aids.pem -r ../../python/ ec2-user@" + ip + ":/home/ec2-user")
