 ...
 * from the specification file <tt>flexEx2.flex</tt>
 */
class content {
  ...
  private static final String ZZ_CMAP_PACKED = 
    "\12\0\1\2\1\3\1\3\1\3\22\0\1\2\15\0\1\2\1\0"+
    "\12\1\1\0\1\2\5\0\32\1\6\0\32\1\12\0\1\3\u1fa2\0"+
  ...
  public static void main(String argv[]) {
    if (argv.length == 0) {
      System.out.println("Usage : java content [ --encoding <name> ] <inputfile(s)>");
    }
    else {
      int firstFilePos = 0;
      ...
      for (int i = firstFilePos; i < argv.length; i++) {
        content scanner = null;
        try {
          java.io.FileInputStream stream = new java.io.FileInputStream(argv[i]);
          java.io.Reader reader = new java.io.InputStreamReader(stream, encodingName);
          scanner = new content(reader);
